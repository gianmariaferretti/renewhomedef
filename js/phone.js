...
function Status({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "rhp-status"
  }, /*#__PURE__*/React.createElement("span", null, "9:41"), /*#__PURE__*/React.createElement("span", {
    className: "rhp-stat-r"
  }, dark ? '📶 🔋' : '📶 🔋'));
}
function Tabs({
  active,
  ...
  const items = [['dashboard', 'Home', 'M3 11l9-8 9 8M5 10v10h14V10'], ['shift', 'Events', 'M13 2 4 14h7l-1 8 9-12h-7z'], ['rewards', 'Rewards', 'M12 2l2.6 6.3L21 9l-5 4.3L17.5 21 12 17.3 6.5 21 8 13.3 3 9l6.4-.7z'], ['impact', 'Impact', 'M4 19V5M4 19h16M8 16l3-4 3 3 4-6']];
  return /*#__PURE__*/React.createElement("div", {
    className: "rhp-tabs"
  }, items.map(([id, label, d]) => /*#__PURE__*/React.createElement("button", {
    key: id,
    className: 'rhp-tab' + (active === id ? ' on' : ''),
    onClick: () => go(id)
...
function ScreenWelcome({
  ...
  }, "\u26A1 Largest residential VPP in the US"), /*#__PURE__*/React.createElement("h1", {
    className: "rhp-h1",
    style: {
      fontSize: 30,
      marginTop: 16
    }
  }, "Turn your home", /*#__PURE__*/React.createElement("br", null), "into savings."), /*#__PURE__*/React.createElement("p", {
    className: "rhp-lead",
    style: {
      marginBottom: 22
    }
  }, "Earn rewards for letting Renew Home gently shift your energy when the grid needs it most \u2014 you stay in control, always.")), /*#__PURE__*/React.createElement("div", {
    className: "rhp-foot"
  }, /*#__PURE__*/React.createElement("button", {
    className: "rhp-pillbtn green",
    onClick: () => go('connect')
  }, "Get started \u2192"), /*#__PURE__*/React.createElement("button", {
    className: "rhp-pillbtn ghost",
...
function ScreenConnect({
  ...
  const rows = [['nest', '🌡️', 'Nest Thermostat', 'Living room · detected'], ['water', '💧', 'Smart Water Heater', 'Add later'], ['battery', '🔋', 'Home Battery / EV', 'Add later']];
  return /*#__PURE__*/React.createElement("div", {
    className: "rhp-screen"
  }, /*#__PURE__*/React.createElement(Status, null), /*#__PURE__*/React.createElement("div", {
    className: "rhp-body"
  }, /*#__PURE__*/React.createElement("h1", {
    className: "rhp-h1"
  }, "Connect a device"), /*#__PURE__*/React.createElement("p", {
    className: "rhp-lead"
  }, "Renew Home works with the smart devices you already own. Connect one to begin."), /*#__PURE__*/React.createElement("div", {
    className: "rhp-scroll",
    style: {
      marginTop: 16,
      display: 'flex',
  ...
  }, rows.map(([id, ico, nm, sb]) => /*#__PURE__*/React.createElement("div", {
    key: id,
    className: 'rhp-list-item' + (sel === id ? ' sel' : ''),
    onClick: () => setSel(id)
  }, /*#__PURE__*/React.createElement("span", {
    className: "ico"
  }, ico), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "nm"
  }, nm), /*#__PURE__*/React.createElement("div", {
    className: "sb"
  }, sb)), /*#__PURE__*/React.createElement("span", {
    className: "rt"
  }, sel === id ? /*#__PURE__*/React.createElement("svg", {
    className: "rhp-svg",
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\uD83D\uDD12"), /*#__PURE__*/React.createElement("span", null, "We never control your home without your limits. You can pause or opt out of any event, anytime.")))), /*#__PURE__*/React.createElement("div", {
    className: "rhp-foot"
  }, /*#__PURE__*/React.createElement("button", {
    className: "rhp-pillbtn green",
    onClick: () => go('comfort')
...
function ScreenComfort({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "rhp-h1"
  }, "Set your comfort"), /*#__PURE__*/React.createElement("p", {
    className: "rhp-lead"
  }, "During an Energy Shift we'll never push past your limits. You're in charge."), /*#__PURE__*/React.createElement("div", {
    className: "rhp-scroll",
    style: {
      marginTop: 16,
      display: 'flex',
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Max temp on a hot day"), /*#__PURE__*/React.createElement("span", {
    style: {
      color: 'var(--ink)',
      fontSize: 14
    }
  }, temp, "\xB0F")), /*#__PURE__*/React.createElement("input", {
    className: "rhp-range",
    type: "range",
    min: "68",
    max: "80",
  ...
  }, /*#__PURE__*/React.createElement("span", null, "68\xB0 cooler"), /*#__PURE__*/React.createElement("span", null, "80\xB0 warmer"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      fontWeight: 700,
      letterSpacing: '.05em',
  ...
  }, "What matters most to you?"), /*#__PURE__*/React.createElement("div", {
    className: "rhp-seg"
  }, [['save', '💰 Save the\u00a0most', 'Max rewards'], ['balanced', '⚖️ Balanced', 'Comfort + savings'], ['comfort', '🛋️ Comfort\u00a0first', 'Subtle shifts']].map(([id, t, s]) => /*#__PURE__*/React.createElement("button", {
    key: id,
    className: 'rhp-segbtn' + (pref === id ? ' on' : ''),
    onClick: () => setPref(id)
  }, /*#__PURE__*/React.createElement("span", {
    className: "t"
    ...
    className: "rhp-info"
  }, /*#__PURE__*/React.createElement("b", null, "How Energy Shifts work"), "When the grid is strained, we pre-cool your home, then ease off during peak hours. You barely notice \u2014 and you earn rewards for the energy you shift."))), /*#__PURE__*/React.createElement("div", {
    className: "rhp-foot"
  }, /*#__PURE__*/React.createElement("button", {
    className: "rhp-pillbtn green",
    onClick: () => go('dashboard')
...
function ScreenDashboard({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "lab"
  }, "Saved this summer"), /*#__PURE__*/React.createElement("div", {
    className: "amt"
  }, "$142.60"), /*#__PURE__*/React.createElement("div", {
    className: "sub"
  }, "+1,240 reward points \xB7 38 Energy Shifts")), /*#__PURE__*/React.createElement("div", {
    className: "rhp-alert",
    onClick: () => go('shift')
  }, /*#__PURE__*/React.createElement("span", {
    className: "ai"
    ...
    className: "at"
  }, "Energy Shift today \xB7 4\u20138 PM"), /*#__PURE__*/React.createElement("div", {
    className: "as"
  }, "Grid demand is high. Tap to see your plan.")), /*#__PURE__*/React.createElement("span", {
    className: "ar"
  }, "\u203A")), /*#__PURE__*/React.createElement("div", {
    className: "rhp-tiles"
  }, /*#__PURE__*/React.createElement("div", {
    ...
    className: "tl"
  }, "Home status"), /*#__PURE__*/React.createElement("div", {
    className: "tv",
    style: {
      color: 'var(--accent-deep)'
    }
  }, "Optimized")), /*#__PURE__*/React.createElement("div", {
    className: "rhp-tile"
  }, /*#__PURE__*/React.createElement("div", {
    className: "tl"
  }, "Now"), /*#__PURE__*/React.createElement("div", {
    className: "tv"
  }, "72\xB0F"))), /*#__PURE__*/React.createElement("div", {
    className: "rhp-card"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
  ...
  }, "This week's impact"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      fontWeight: 800,
      color: 'var(--accent-deep)'
    ...
    className: "rhp-bars"
  }, [42, 55, 48, 67, 60, 82, 70].map((h, i) => /*#__PURE__*/React.createElement("i", {
    key: i,
    style: {
      height: h + '%'
    }
  ...
  }, "kWh shifted \xB7 Mon\u2013Sun")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 6
    }
...
function ScreenShift({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "rhp-chip",
    style: {
      background: 'rgba(247,177,59,.22)',
      color: '#ffd089',
      alignSelf: 'center'
    }
  }, "\u26A1 Energy Shift in progress"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 20,
      fontWeight: 800,
      color: '#fff'
    }
  }, "Peak hours \xB7 4\u20138 PM"), /*#__PURE__*/React.createElement("div", {
    className: "rhp-lead",
    style: {
      marginTop: 4
    }
  }, "We pre-cooled your home to 70\xB0. Now easing off to support the grid.")), /*#__PURE__*/React.createElement("div", {
    className: "rhp-ring",
    style: {
      ['--pct']: 72
    }
    ...
    className: "rc"
  }, /*#__PURE__*/React.createElement("b", null, "2h 14m"), /*#__PURE__*/React.createElement("span", null, "remaining"))), /*#__PURE__*/React.createElement("div", {
    className: "rhp-darkcard"
  }, /*#__PURE__*/React.createElement("div", {
    className: "dl"
  }, "Comfort"), /*#__PURE__*/React.createElement("div", {
    className: "dv"
  }, /*#__PURE__*/React.createElement("span", null, "Holding at 74\xB0F"), /*#__PURE__*/React.createElement("span", null, "\uD83D\uDE0C"))), /*#__PURE__*/React.createElement("div", {
    className: "rhp-darkcard",
    style: {
  ...
  }, "Earning right now"), /*#__PURE__*/React.createElement("div", {
    className: "dv"
  }, /*#__PURE__*/React.createElement("span", null, "+$6.40 \xB7 90 pts"), /*#__PURE__*/React.createElement("span", null, "\uD83D\uDCB0"))), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10,
      fontWeight: 700,
      letterSpacing: '.06em',
  ...
  }, "Too warm? You're in control."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 9
    }
  }, /*#__PURE__*/React.createElement("button", {
    className: 'rhp-pillbtn ' + (comfy === 'stay' ? 'green' : 'ghost'),
    onClick: () => setComfy('stay')
  }, "Stay in \u2014 I'm comfy"), /*#__PURE__*/React.createElement("button", {
    className: 'rhp-pillbtn ' + (comfy === 'opt' ? 'soft' : 'ghost'),
    onClick: () => setComfy('opt')
  }, "Opt out")), /*#__PURE__*/React.createElement("div", {
    style: {
      height: 4
    }
  }))), /*#__PURE__*/React.createElement("div", {
...
function ScreenRewards({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "sub"
  }, "+240 points \xB7 3.1 kWh shifted")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10.5,
      fontWeight: 700,
      letterSpacing: '.05em',
  ...
  }, "Redeem your 1,480 points"), rows.map(([ico, nm, sb, pr]) => /*#__PURE__*/React.createElement("div", {
    key: nm,
    className: "rhp-redeem"
  }, /*#__PURE__*/React.createElement("span", {
    className: "ico"
  }, ico), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    className: "nm"
...
function ScreenImpact({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "tl"
  }, "CO\u2082 avoided"), /*#__PURE__*/React.createElement("div", {
    className: "tv"
  }, "312 lbs")), /*#__PURE__*/React.createElement("div", {
    className: "rhp-tile"
  }, /*#__PURE__*/React.createElement("div", {
    className: "tl"
  }, "= Trees"), /*#__PURE__*/React.createElement("div", {
    className: "tv"
  }, "\uD83C\uDF33 6"))), /*#__PURE__*/React.createElement("div", {
    className: "rhp-nbr"
  }, /*#__PURE__*/React.createElement("div", {
    className: "nl"
  }, "Maple Street neighborhood"), /*#__PURE__*/React.createElement("div", {
    className: "nv"
  }, "Together you shifted 1.2 MWh this month \u26A1"), /*#__PURE__*/React.createElement("div", {
    className: "ns"
  }, "That's enough to power 40 homes for a day.")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 10.5,
      fontWeight: 700,
      letterSpacing: '.05em',
  ...
  }, "Neighborhood leaderboard"), /*#__PURE__*/React.createElement("div", null, board.map(([rk, ic, nm, kv, me]) => /*#__PURE__*/React.createElement("div", {
    key: nm,
    className: 'rhp-lead-row' + (me ? ' me' : '')
  }, /*#__PURE__*/React.createElement("span", {
    className: "rk"
    ...
    style: {
      ...
      height: 24,
      fontSize: 10,
      background: me ? 'linear-gradient(135deg,#bfeccf,#1d9e75)' : 'var(--paper-3)'
    }
    ...
    className: "rhp-pillbtn green",
    onClick: () => go('share')
  }, "\uD83D\uDCE3 Share my impact"))), /*#__PURE__*/React.createElement(Tabs, {
    active: "impact",
    go: go
  }));
}
function ScreenShare({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "rhp-sharecard"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      color: 'rgba(255,255,255,.78)'
    }
  }, "Maya's summer with Renew Home"), /*#__PURE__*/React.createElement("div", {
    className: "amt"
  ...
  }, "saved \xB7 312 lbs CO\u2082 avoided"), /*#__PURE__*/React.createElement("div", {
    className: "q"
  }, "\"I lowered my bill without lifting a finger \u2014 and helped keep the lights on for Texas.\" \uD83D\uDC9A")), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 13,
  ...
  }, "Refer a neighbor \u2014 you both get ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: '#7ef0ab'
    }
  }, "$25"), " when they enroll."))), /*#__PURE__*/React.createElement("div", {
    className: "rhp-foot"
  }, /*#__PURE__*/React.createElement("button", {
    className: "rhp-pillbtn green",
    onClick: () => go('share')
  }, "Invite neighbors"), /*#__PURE__*/React.createElement("button", {
    className: "rhp-pillbtn ghost",
    onClick: () => go('share')
  }, "Share my impact card"), /*#__PURE__*/React.createElement("button", {
    className: "rhp-mini-restart",
    onClick: () => go('welcome')
  }, "\u21BA Restart prototype")));
}
const SCREENS = {
...
function App() {
  ...
  useEffect(() => {
    ...
    mo.observe(root, {
      attributes: true,
      attributeFilter: ['data-phone-layout']
    });
  ...
  if (layout === 'single') {
    ...
    }, ORDER.map((s, i) => /*#__PURE__*/React.createElement("i", {
      key: s,
      className: i === idx ? 'on' : '',
      style: {
        width: 9,
  ...
  if (layout === 'trio') {
    return /*#__PURE__*/React.createElement("div", {
      className: "rhp-stage trio"
    }, /*#__PURE__*/React.createElement(SidePhone, {
      screen: "welcome"
    }), /*#__PURE__*/React.createElement("div", {
      style: {
        display: 'flex',
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "rhp-stage showcase"
  }, phone, /*#__PURE__*/React.createElement("div", {
    className: "rhp-cap"
  }, /*#__PURE__*/React.createElement("div", {
    className: "rhp-step"
  }, cap[0]), /*#__PURE__*/React.createElement("h3", null, cap[1]), /*#__PURE__*/React.createElement("p", null, cap[2]), /*#__PURE__*/React.createElement("div", {
    className: "rhp-dots"
  }, ORDER.map((s, i) => /*#__PURE__*/React.createElement("i", {
    key: s,
    className: i === idx ? 'on' : '',
...
(function mountPhone() {
  ...
  const root = document.getElementById('phone-root');
  if (root) ReactDOM.createRoot(root).render(/*#__PURE__*/React.createElement(App, null));
})();
